...
export default function AdminSidebar() {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? "bg-[#7C3AED]/10 text-[#7C3AED] border-[#7C3AED]/20 shadow-[0_0_15px_rgba(124,58,237,0.05)]"
                                    : "text-[#E0E0E0] hover:bg-[#252525] hover:text-white"
                            )}
                        >
                            <div className="flex items-center space-x-3">
                                <item.icon className={cn("h-4.5 w-4.5", isActive ? "text-[#7C3AED]" : "text-slate-400 group-hover:text-white transition-colors")} />
                                <span className="font-semibold text-sm tracking-tight">{item.name}</span>
                            </div>
                            {isActive && <ChevronRight className="h-3.5 w-3.5 text-[#7C3AED]/75" />}
                        </Link>
                    );
                })}
            </nav>
    ...
    return (
        <>
            {/* Desktop Sidebar — always visible on lg+ and sticky top-0 to never disappear */}
            <aside className="hidden lg:flex w-64 h-screen bg-[#1A1A1A] border-r border-[#3A3A3A] flex-col sticky top-0 transition-colors duration-200 z-30 shrink-0">
                <SidebarContent />
            </aside>
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "bg-[#7C3AED]/10 text-[#7C3AED] border-[#7C3AED]/25 scale-105 shadow-[0_0_15px_rgba(124,58,237,0.05)]"
