            ...
            <Card className="border-slate-200 shadow-sm overflow-hidden rounded-xl bg-white">
                ...
                <CardContent className="p-6 space-y-6">
                    ...
                    <div className="space-y-1.5 pt-2 border-t border-slate-50">
                        ...
                        <Input id="notificationEmail" type="email" value={formData.notificationEmail || ""} onChange={handleChange} placeholder="notificaciones@groomingpet.com" className="h-11 border-primary/20 bg-primary/5 rounded-lg font-medium" />
                        <p className="text-[10px] text-slate-400 font-medium">Este correo recibirá los mensajes directos de los clientes.</p>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 shadow-sm overflow-hidden rounded-xl bg-white">
                ...
                <CardContent className="p-6 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-3">
                            <div className="space-y-1.5">
                                <Label htmlFor="facebookUrl" className="flex items-center text-xs font-semibold text-slate-500"><Facebook className="h-3.5 w-3.5 mr-2" /> Facebook</Label>
                                <Input id="facebookUrl" value={formData.facebookUrl || ""} onChange={handleChange} placeholder="URL de perfil" className="h-11 border-slate-200 rounded-lg" />
                            </div>
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-100">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Estado Visible</span>
                                <Switch 
