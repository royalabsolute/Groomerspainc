            ...
            >
                ...
                <Card className="border-4 border-black shadow-[8px_8px_0px_0px_#000] md:shadow-[16px_16px_0px_0px_#000] bg-white overflow-hidden rounded-[2rem] md:rounded-[2.5rem]">
                    <CardHeader className="space-y-2 bg-secondary/10 border-b-4 border-black p-5 md:p-8">
                        ...
                        <CardDescription className="text-foreground/80 font-bold text-base md:text-lg leading-tight">
                            Ingresa tu email y te enviaremos un enlace maestro para restablecer tu contraseña.
                        </CardDescription>
                    </CardHeader>
                        ...
                        {isSubmitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-3">
                                    <Label htmlFor="email" className="font-black uppercase text-[10px] md:text-xs tracking-widest ml-1">Email de Administrador</Label>
                ...
                <div className="relative mt-12 flex flex-col items-center">
                    ...
                    <p className="text-center text-xs text-foreground uppercase tracking-[0.3em] font-black bg-white border-2 border-black px-4 py-1 rounded-full shadow-[3px_3px_0px_0px_#000]">
                        Recuperación Segura &bull; GroomingPet System
                    </p>
                </div>
            </motion.div>
        </div>
